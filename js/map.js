var appMap = {
  ...
  dataURL : 'https://opendata.paris.fr/api/records/1.0/search/?dataset=velib-disponibilite-en-temps-reel&rows=-1',
  markers : [],
  ...
  setMarker :  function (fields) {
    ...
    newMarker.station.init(fields.station_id, newMarker.title, fields.is_renting, fields.numdocksavailable, fields.numbikesavailable, 'address');
  ...
  setMakersIcons : function () {
    for (i in this.markers){
      ...
      }else if(marker.station.is_renting === 1 && marker.station.numbikesavailable > 0){
